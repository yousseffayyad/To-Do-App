...
- (void)viewDidLoad {
    ...
    self.doneTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
    self.doneTableView.separatorInset = UIEdgeInsetsZero;
    self.doneTableView.layoutMargins = UIEdgeInsetsZero;
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    for (Task *task in allTasks) {
        if ([task.taskStatus isEqualToString:@"Done"]) {
